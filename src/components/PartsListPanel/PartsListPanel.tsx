...
const ExplodeToggle = () => {
  ...
  return (
    <div className={s.actionToggle}>
      ...
      <button className={clsx(s.toggle, isOn && s.toggleOn)} onClick={() => setConfig({ explodeStatus: !isOn })}>
...
const AnnotationsToggle = () => {
  ...
  return (
    <div className={s.actionToggle}>
      ...
      <button className={clsx(s.toggle, isOn && s.toggleOn)} onClick={() => setConfig({ annotationsVisible: !isOn })}>
        <span className={s.toggleThumb} />
      </button>
    </div>
  );
...
export const PartsListPanel = () => {
  ...
  if (!isOpen) {
    return (
      <button className={clsx(s.collapsedButton, showCollapsed && s.collapsedButtonVisible)} onClick={handleOpen}>
        <CogIcon />
